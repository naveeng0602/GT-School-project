  ...
  return (
    <div>
        <div className="container">
            <h2 className='text-center mb-5'>Why choose GT Valley International School ?</h2>
                    ...
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            <Card.Title className='text-center text-capitalize mb-3'>
                                10+ trophies received
                            </Card.Title>
                            <Card.Text className='text-center'>
                            Our school proudly receives a trophy, celebrating our students' remarkable achievements. This recognition honors their hard work and dedication, inspiring us all to continue striving for excellence. Congratulations to our outstanding students.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
...
At our school, student happiness is paramount. Through engaging lessons, supportive teachers, and a vibrant community, we foster a positive environment where every student feels valued and empowered to succeed.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                            Gopalganj, boasts rich cultural heritage. Its vibrant community, diverse traditions, and scenic landscapes make it a truly unique and enchanting place to live.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
