...
import Blog1Img from '../utils/images/Team1.png';
import Blog2Img from '../utils/images/Team2.png';
import Blog3Img from '../utils/images/Team3.png'
const blogs = [
    {
        id: 1,
        img: [Blog1Img],
        title: 'MR. CHANDRA SHEKHAR SHUKLA',
        description: 'Founder/Director'
    },
    {
        id: 2,
        img: [Blog2Img],
        title: 'Mr. SAMANJH OCIE',
        description: 'Principal'
    },
    {
        id: 3,
        img: [Blog3Img],
        title: 'Dr GHANSYAM ROY',
  ...
  return (
    <div className='faq-section'>
        <div className='container d-flex flex-column align-items-center'>
            <h2 className='text-center text-capitalize mb-5'>Founder</h2>
